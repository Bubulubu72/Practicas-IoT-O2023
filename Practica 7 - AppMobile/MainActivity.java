...
public class MainActivity extends Activity {
    ...
    public class ApiUbidots extends AsyncTask<Integer, ProgressUpdate, Void> {
        private final String API_KEY_UBIDOTS = "BBFF-";
        private final String TempVariable_ID = "Cambiado Por Seguridad";
        private final String HumVariable_ID = "Cambiado Por Seguridad";
